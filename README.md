...
1. Make sure your repository does not include real secrets.
2. Keep `.env` out of GitHub.
3. Keep `__pycache__` out of GitHub.
...
## Should `__pycache__` Be On GitHub?

No. `__pycache__` contains generated Python bytecode files and should not be committed.
...
- `.env` and `__pycache__` should stay out of the repository.
